"""
Load pandas.DataFrame objects (using configurations in *.conf file in this dir) from cached TERYT register databases.

Variables `simc_csv', `terc_csv' and `nts_csv' contain _io text wrappers of *.csv databases from the Polish TERYT
register.
